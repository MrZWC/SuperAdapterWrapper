    ...
    public void runPendingAnimations() {
        ...
        if (movesPending) {
            ...
            if (removalsPending) {
                ...
                ViewCompat.postOnAnimationDelayed(view, mover, getRemoveDuration() * 0);
            } else {
                mover.run();
            }
        }
        ...
        if (changesPending) {
            ...
            if (removalsPending) {
                ...
                ViewCompat.postOnAnimationDelayed(holder.itemView, changer, getRemoveDuration() * 0);
            } else {
                changer.run();
            }
        }
        ...
        if (additionsPending) {
            ...
            if (removalsPending || movesPending || changesPending) {
                ...
                ViewCompat.postOnAnimationDelayed(view, adder, totalDelay * 0);
            } else {
                adder.run();
            }
        }
