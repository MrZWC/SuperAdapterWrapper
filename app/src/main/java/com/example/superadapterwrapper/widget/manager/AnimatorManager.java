 ...
 * Time: 10:47
 */
public class AnimatorManager extends RecyclerView.LayoutManager {
     ...
     */
    public AnimatorManager(Context context, int orientation) {
        this(context,orientation,false);
    }

    public AnimatorManager(Context context, int orientation, boolean reverseLayout) {
    ...
    /**
     * Sets the orientation of the layout. {@link AnimatorManager}
